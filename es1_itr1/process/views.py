...
from vector_injest.models import DatasetUnit
...
#     html = ""
#     for folder_name, contents in directory_structure.items():
...
#                 html += f"<div style='margin-left: {(indent_level + 1) * 20}px;'>{file_name}</div>"
#     return html
...
def detail(request, pk, object_name):
